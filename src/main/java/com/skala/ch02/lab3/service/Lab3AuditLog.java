package com.skala.ch02.lab3.service;
...
/**
 * 감사 로그 — 한 요청을 처음부터 끝까지 {@code traceId} 로 따라갈 수 있게 한 곳에 모은다.
 *
 * <p>{@link com.skala.ch02.lab3.advisor.AuditAdvisor}(요청·응답)와
 * {@link com.skala.ch02.lab3.tool.OrderTools}(도구 호출)가 같은 로거를 나눠 쓴다 — Advisor
 * 컨텍스트와 {@code ToolContext} 는 서로 다른 통로라 traceId 를 양쪽에 각각 심어 둬야
 * 여기서 다시 만난다.
 */
@Component
public class Lab3AuditLog {
