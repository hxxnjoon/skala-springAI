...
import com.skala.ch02.lab3.dto.ErrorResponse;

@RestControllerAdvice(basePackages = "com.skala.ch02.lab3.web") // /lab3/** 로만 한정
class Lab3ExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(Lab3ExceptionHandler.class);
